/**
  * bootstrap-table - An extended Bootstrap table with radio, checkbox, sort, pagination, and dashboard added features. (supports twitter bootstrap v2 and v3).
  *
  * @version v1.14.2
